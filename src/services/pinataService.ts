...
export const SMS_LOGO_IPFS_GATEWAY = 'https://ipfs.io/ipfs/QmRMejDwaKRZSAqkwPhbeDJGrjDjGkwrKZRnwbTTscQHur';
export const SMS_LOGO_IPFS_URI = 'https://ipfs.io/ipfs/QmRMejDwaKRZSAqkwPhbeDJGrjDjGkwrKZRnwbTTscQHur';
